...
type AnalyticsServiceClient interface {
	RecordEvent(ctx context.Context, in *RecordEventRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *analyticsServiceClient) RecordEvent(ctx context.Context, in *RecordEventRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type AnalyticsServiceServer interface {
	RecordEvent(context.Context, *RecordEventRequest) (*emptypb.Empty, error)
...
func (UnimplementedAnalyticsServiceServer) RecordEvent(context.Context, *RecordEventRequest) (*emptypb.Empty, error) {
